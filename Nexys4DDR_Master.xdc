...
# create_generated_clock -name clkdiv4_0 -source [get_ports clk] -divide_by 4 [get_pins div1/real_clk];
# create_clock -add -name sys_clk_pin -period 12.5 -waveform {0 6.25} [get_ports { real_clk }];
# create_clock -add -name sys_clk_pin -period 40 -waveform {0 20} [get_ports { vga_clk }];
